...
public final class EnchantmentGlintSubCommand extends BrigadierCommand {
    ...
    private int handleEnchantmentGlintUpdate(final @NotNull CommandContext<CommandSourceStack> context, UnaryOperator<ItemMeta> function) {
